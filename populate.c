...
void populateAddressBook(AddressBook* addressBook)
{
    ...
    {
        addressBook->contacts[addressBook->contactCount++] = dummyContacts[i];  //try saving indivisually
    }
}